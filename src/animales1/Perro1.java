...
public class Perro1 extends Animal1 {
    ...
    public Perro1(String codigo, String fechaNacimiento, char sexo, double peso, String raza) throws IllegalArgumentException {
    ...
    public Perro1(Perro1 otroPerro) throws IllegalArgumentException {
        super(otroPerro);
    }

    public Perro1(String raza, Animal1 OtroAnimal) {
        super(OtroAnimal);
        this.raza = raza;
    }
